...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--existing\033[0m|\033[1m-e\033[0m            Treat the argument as an existing package archive path" << ::std::endl
       << "                         rather than the package name/version to fetch." << ::std::endl;
  ...
  struct _cli_pkg_fetch_options_map_init
  {
    _cli_pkg_fetch_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_fetch_options, bool, &pkg_fetch_options::replace_ >;
      _cli_pkg_fetch_options_map_["-r"] =
      &::bpkg::cli::thunk< pkg_fetch_options, bool, &pkg_fetch_options::replace_ >;
      _cli_pkg_fetch_options_map_["--existing"] =
      &::bpkg::cli::thunk< pkg_fetch_options, bool, &pkg_fetch_options::existing_ >;
      _cli_pkg_fetch_options_map_["-e"] =
      &::bpkg::cli::thunk< pkg_fetch_options, bool, &pkg_fetch_options::existing_ >;
      _cli_pkg_fetch_options_map_["--purge"] =
      &::bpkg::cli::thunk< pkg_fetch_options, bool, &pkg_fetch_options::purge_ >;
