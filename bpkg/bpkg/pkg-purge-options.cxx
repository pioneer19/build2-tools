...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       ...
       << "                         that the package directory and archive no longer exist" << ::std::endl
       << "                         and then remove the package from the configuration." << ::std::endl;
  ...
  struct _cli_pkg_purge_options_map_init
  {
    _cli_pkg_purge_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_purge_options, bool, &pkg_purge_options::keep_ >;
      _cli_pkg_purge_options_map_["-k"] =
      &::bpkg::cli::thunk< pkg_purge_options, bool, &pkg_purge_options::keep_ >;
      _cli_pkg_purge_options_map_["--force"] =
      &::bpkg::cli::thunk< pkg_purge_options, bool, &pkg_purge_options::force_ >;
