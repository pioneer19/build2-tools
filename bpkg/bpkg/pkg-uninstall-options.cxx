...
namespace bpkg
{
  ...
  struct _cli_pkg_uninstall_options_map_init
  {
    _cli_pkg_uninstall_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_uninstall_options, bool, &pkg_uninstall_options::all_ >;
      _cli_pkg_uninstall_options_map_["-a"] =
      &::bpkg::cli::thunk< pkg_uninstall_options, bool, &pkg_uninstall_options::all_ >;
      _cli_pkg_uninstall_options_map_["--immediate"] =
      &::bpkg::cli::thunk< pkg_uninstall_options, bool, &pkg_uninstall_options::immediate_ >;
      _cli_pkg_uninstall_options_map_["-i"] =
      &::bpkg::cli::thunk< pkg_uninstall_options, bool, &pkg_uninstall_options::immediate_ >;
      _cli_pkg_uninstall_options_map_["--recursive"] =
      &::bpkg::cli::thunk< pkg_uninstall_options, bool, &pkg_uninstall_options::recursive_ >;
...
namespace bpkg
{
  ...
  print_bpkg_pkg_uninstall_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "\033[1mbpkg pkg-uninstall\033[0m|\033[1muninstall\033[0m [\033[4moptions\033[0m] [\033[4mvars\033[0m] \033[1m--all\033[0m|\033[1m-a\033[0m\033[0m" << ::std::endl
       << ::std::endl
       << "\033[1mDESCRIPTION\033[0m" << ::std::endl
       << ::std::endl
       << "The \033[1mpkg-uninstall\033[0m command uninstalls the specified packages (the first form) or" << ::std::endl
       << "all held packages (the second form, see \033[1mbpkg-pkg-status(1)\033[0m). Additionally," << ::std::endl
       << "immediate or all dependencies of these specified packages can be also" << ::std::endl
       << "uninstalled by specifying the \033[1m--immediate\033[0m|\033[1m-i\033[0m\033[0m or \033[1m--recursive\033[0m|\033[1m-r\033[0m\033[0m options," << ::std::endl
       << "respectively. Underneath, this command doesn't do much more than run \033[1mb" << ::std::endl
