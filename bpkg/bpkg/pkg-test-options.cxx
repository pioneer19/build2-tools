...
namespace bpkg
{
  ...
  print_bpkg_pkg_test_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "\033[1mbpkg pkg-test\033[0m|\033[1mtest\033[0m [\033[4moptions\033[0m] [\033[4mvars\033[0m] \033[1m--all\033[0m|\033[1m-a\033[0m\033[0m" << ::std::endl
       << ::std::endl
       << "\033[1mDESCRIPTION\033[0m" << ::std::endl
       << ::std::endl
       << "The \033[1mpkg-test\033[0m command tests the specified packages (the first form) or all the" << ::std::endl
       << "held packages (the second form, see \033[1mbpkg-pkg-status(1)\033[0m). Additionally," << ::std::endl
       << "immediate or all dependencies of these packages can also be tested by" << ::std::endl
       << "specifying the \033[1m--immediate\033[0m|\033[1m-i\033[0m\033[0m or \033[1m--recursive\033[0m|\033[1m-r\033[0m\033[0m options, respectively." << ::std::endl
       << "Underneath, this command doesn't do much more than run \033[1mb test\033[0m. In the first" << ::std::endl
       << "form the specified packages must have been previously configured with" << ::std::endl
