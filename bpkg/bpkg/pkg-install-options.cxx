...
namespace bpkg
{
  ...
  struct _cli_pkg_install_options_map_init
  {
    _cli_pkg_install_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_install_options, bool, &pkg_install_options::all_ >;
      _cli_pkg_install_options_map_["-a"] =
      &::bpkg::cli::thunk< pkg_install_options, bool, &pkg_install_options::all_ >;
      _cli_pkg_install_options_map_["--immediate"] =
      &::bpkg::cli::thunk< pkg_install_options, bool, &pkg_install_options::immediate_ >;
      _cli_pkg_install_options_map_["-i"] =
      &::bpkg::cli::thunk< pkg_install_options, bool, &pkg_install_options::immediate_ >;
      _cli_pkg_install_options_map_["--recursive"] =
      &::bpkg::cli::thunk< pkg_install_options, bool, &pkg_install_options::recursive_ >;
...
namespace bpkg
{
  ...
  print_bpkg_pkg_install_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "\033[1mbpkg pkg-install\033[0m|\033[1minstall\033[0m [\033[4moptions\033[0m] [\033[4mvars\033[0m] \033[1m--all\033[0m|\033[1m-a\033[0m\033[0m" << ::std::endl
       << ::std::endl
       << "\033[1mDESCRIPTION\033[0m" << ::std::endl
       << ::std::endl
       << "The \033[1mpkg-install\033[0m command installs the specified packages (the first form) or all" << ::std::endl
       << "held packages (the second form, see \033[1mbpkg-pkg-status(1)\033[0m). Additionally," << ::std::endl
       << "immediate or all dependencies of these packages can be also installed by" << ::std::endl
       ...
       << "Underneath, this command doesn't do much more than run \033[1mb install\033[0m. In the first" << ::std::endl
