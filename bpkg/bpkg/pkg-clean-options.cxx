...
namespace bpkg
{
  ...
  struct _cli_pkg_clean_options_map_init
  {
    _cli_pkg_clean_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_clean_options, bool, &pkg_clean_options::all_ >;
...
namespace bpkg
{
  ...
  print_bpkg_pkg_clean_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "\033[1mbpkg pkg-clean\033[0m|\033[1mclean\033[0m [\033[4moptions\033[0m] [\033[4mvars\033[0m] \033[1m--all\033[0m|\033[1m-a\033[0m\033[0m" << ::std::endl
       << ::std::endl
       << "\033[1mDESCRIPTION\033[0m" << ::std::endl
       << ::std::endl
       << "The \033[1mpkg-clean\033[0m command cleans the specified packages (the first form) or all the" << ::std::endl
       << "held packages (the second form, see \033[1mbpkg-pkg-status(1)\033[0m). Underneath, this" << ::std::endl
       << "command doesn't do much more than run \033[1mb clean\033[0m. In the first form the specified" << ::std::endl
       << "packages must have been previously configured with \033[1mbpkg-pkg-build(1)\033[0m or" << ::std::endl
       << "\033[1mbpkg-pkg-configure(1)\033[0m." << ::std::endl
       << ::std::endl
