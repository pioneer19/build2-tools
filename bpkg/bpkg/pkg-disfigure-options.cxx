...
namespace bpkg
{
  ...
  struct _cli_pkg_disfigure_options_map_init
  {
    _cli_pkg_disfigure_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_disfigure_options, bool, &pkg_disfigure_options::keep_out_ >;
    }
  };
...
namespace bpkg
{
  ...
  print_bpkg_pkg_disfigure_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << ::std::endl
       << "By default \033[1mpkg-disfigure\033[0m will also clean the package's output directory. This" << ::std::endl
       << "behavior can be suppressed with the \033[1m--keep-out\033[0m option, for example, if the" << ::std::endl
       << "package is to be reconfigured." << ::std::endl;
