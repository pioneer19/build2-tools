...
namespace bdep
{
  ...
  print_bdep_update_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "configurations. Underneath it executes the \033[1mbpkg-pkg-update(1)\033[0m command which" << ::std::endl
       << "itself is not much more than the build system \033[1mupdate\033[0m operation (see \033[1mb(1)\033[0m for" << ::std::endl
