...
namespace bdep
{
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--force\033[0m                 Deinitialize packages without attempting to remove them" << ::std::endl
       << "                        from the build configuration. This mode is primarily" << ::std::endl
       << "                        useful when the configuration directory has been" << ::std::endl
       << "                        removed or is otherwise unusable." << ::std::endl;
  ...
  struct _cli_cmd_deinit_options_map_init
  {
    _cli_cmd_deinit_options_map_init ()
    {
      ...
      &::bdep::cli::thunk< cmd_deinit_options, bool, &cmd_deinit_options::force_ >;
    }
  };
